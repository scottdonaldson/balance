...
<section id="pilates" style="background-image: url(<?= get_bloginfo('template_url'); ?>/images/home/pilates.jpg); z-index: 5;">
	<div class="full-width">
		<div class="height-100">
			<div class="module abs bottom left">
				<div class="content">
					<h2>Pilates</h2>
...
<section id="yoga" style="background-image: url(<?= get_bloginfo('template_url'); ?>/images/home/yoga.jpg); z-index: 4;">
	<div class="full-width">
		<div class="height-100">
			<div class="module abs bottom right">
				<div class="content">
					<h2>Yoga</h2>
...
<section id="gyrotonics" style="background-image: url(<?= get_bloginfo('template_url'); ?>/images/home/gyrotonics.jpg); z-index: 3;">
	<div class="full-width">
		<div class="height-100">
			<div class="module abs bottom left">
				<div class="content">
...
<section id="vbarre" style="background-image: url(<?= get_bloginfo('template_url'); ?>/images/home/vbarre.jpg); z-index: 2;">
	<div class="full-width">
		<div class="height-100">
			<div class="module abs bottom right">
				<div class="content">
